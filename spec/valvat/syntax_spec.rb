...
describe Valvat::Syntax do
  describe '#validate' do
    ...
    it_validates(['CHE-343.663.860', 'CHE-343.663.860MWST', 'CHE-343.663.860 MWST', 'CHE343663860', 'CHE343663860MWST',
                  'CHE343663860 MWST'],
                 ['CHE-343.663.8601', 'CHE-343.663.8601MWST', 'CHE-343.663.8601 MWST', 'CHE-34.663.860',
                  'CHE-34.663.860MWST', 'CHE-34.663.860 MWST'])
    it_validates(['CHE-343.663.860', 'CHE-343.663.860TVA', 'CHE-343.663.860 TVA', 'CHE343663860', 'CHE343663860TVA',
                  'CHE343663860 TVA'],
                 ['CHE-343.663.8601', 'CHE-343.663.8601TVA', 'CHE-343.663.8601 TVA', 'CHE-34.663.860',
                  'CHE-34.663.860TVA', 'CHE-34.663.860 TVA'])
    it_validates(['CHE-343.663.860', 'CHE-343.663.860IVA', 'CHE-343.663.860 IVA', 'CHE343663860', 'CHE343663860IVA',
                  'CHE343663860 IVA'],
    ...
    it_validates(%w[NO997770234MVA NO997770234], %w[NO12345678910 NO12345678 NO12345678910MVA NO12345678MVA])
